...
def eval_df(df, input_col, target_style_col, dataset_name, prompt_style="zero_shoot", output_dir="outputs"):
...
if __name__ == "__main__":
    ...
    eval_df(df.iloc[0:1, :], "input", "target_style", "GYAFC_dummy", prompt_style="zero_shoot")
    ...
    # df = df.iloc[0:100, :]
    # print(len(df))
    # eval_df(df, "input", "target_style", "GYAFC_100", prompt_style="zero_shoot")
